...
class Generator extends \yii\gii\generators\model\Generator
{
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {
            ...
            // base model
            $baseModelClassName = 'Base' . $modelClassName;
            $files[] = new CodeFile(
                Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $baseModelClassName . '.php',
    ...
    public function generateRules($table)
    {
        ...
        foreach ($table->foreignKeys as $refs) {
            ...
            $rules[] = "[['$attributes'], 'exist', 'skipOnError' => true, 'targetClass' => Base$refClassName::class, 'targetAttribute' => [$targetAttributes]]";
        }
